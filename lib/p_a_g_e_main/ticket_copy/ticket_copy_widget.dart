...
import 'ticket_copy_model.dart';
export 'ticket_copy_model.dart';

class TicketCopyWidget extends StatefulWidget {
  const TicketCopyWidget({super.key});

  static String routeName = 'ticketCopy';
  static String routePath = 'ticketCopy';

  @override
  State<TicketCopyWidget> createState() => _TicketCopyWidgetState();
}

class _TicketCopyWidgetState extends State<TicketCopyWidget>
    with TickerProviderStateMixin {
  late TicketCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TicketCopyModel());
