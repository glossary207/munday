...
import '/components/allphoto_widget.dart';
import '/components/appbarsilver_widget.dart';
import '/components/popupmap_widget.dart';
import '/components/poster_present_widget.dart';
import '/components/review_widget.dart';
import '/components/reviewgive_widget.dart';
import '/components/rowpromotion_widget.dart';
import '/components/showpeople_widget.dart';
import '/components/showphoto_widget.dart';
import '/components/story_view_widget.dart';
...
import 'in_venuse_copy_model.dart';
export 'in_venuse_copy_model.dart';

class InVenuseCopyWidget extends StatefulWidget {
  const InVenuseCopyWidget({
    super.key,
    this.idVenues,
    this.distance,
    this.dateclick,
  ...
  static String routeName = 'InVenuseCopy';
  static String routePath = 'inVenuseCopy';

  @override
  State<InVenuseCopyWidget> createState() => _InVenuseCopyWidgetState();
}

class _InVenuseCopyWidgetState extends State<InVenuseCopyWidget>
    with TickerProviderStateMixin {
  late InVenuseCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InVenuseCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<VenuesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final inVenuseCopyVenuesRecord = snapshot.data!;
                      ...
                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              child: Container(
                                                width: inVenuseCopyVenuesRecord
                                                            .video.length !=
                                                        0
                                                    ? 115.0
                                                    : 100.0,
                                                height: inVenuseCopyVenuesRecord
                                                            .video.length !=
                                                        0
                                                    ? 115.0
                                                    : 100.0,
                                                                      ...
                                                                      return GestureDetector(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              ReviewWidget(
                                                                            idVenues:
                                                                                inVenuseCopyVenuesRecord.reference,
                                                                          ),
                                                                        ),
                                                                      );
                                                                    },
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          formatNumber(
                                                                            inVenuseCopyVenuesRecord.rating,
                                                                            formatType:
                                                                                FormatType.custom,
                                                                            format:
                                                                                '.0',
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            PopupmapWidget(
                                                                          location:
                                                                              inVenuseCopyVenuesRecord.position!,
                                                                          distance:
                                                                              widget.distance!,
                                                                          logo:
                                                                              inVenuseCopyVenuesRecord.logo,
                                                                          name:
                                                                              inVenuseCopyVenuesRecord.nameVenuse,
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
                                                              ...
                                                              if (inVenuseCopyVenuesRecord
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      await launchURL(functions.linkLine(inVenuseCopyVenuesRecord
                                                                          .linkContact
                                                                          .line)!);
                                                                    },
                                                                    child:
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'el6ri3xf' /* Sorry, we don't have events to... */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'mhrkr17v' /* Sorry, we don’t have promotion... */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
                        ...
                        StreamBuilder<UserInVenuesRecord>(
                          stream: UserInVenuesRecord.getDocument(
                              inVenuseCopyVenuesRecord.refUserInVenues!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: wrapWithModel(
                                                            ...
                                                            child:
                                                                ShowpeopleWidget(
                                                              refdoc: inVenuseCopyVenuesRecord
                                                                  .refUserInVenues!,
                                                              date: FFAppState()
                                                                  .dateclick!,
                                                            ),
