...
class MundayButtonTabBar extends ConsumerStatefulWidget
  ...
  /// and the entire [MundayButtonTabBar] is scrollable. Otherwise each tab gets an equal
...
class _MundayButtonTabBarState extends ConsumerState<MundayButtonTabBar>
  ...
  @override
  void didUpdateWidget(MundayButtonTabBar oldWidget) {
