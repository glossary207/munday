...
class MundayIconButton extends ConsumerStatefulWidget {
  const MundayIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  ConsumerState<MundayIconButton> createState() => _MundayIconButtonState();
}

class _MundayIconButtonState extends ConsumerState<MundayIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(MundayIconButton oldWidget) {
