...
import 'package:munday/core/types/lat_lng.dart' as latlng;
...
class MundayMarker {
  const MundayMarker(this.markerId, this.location, [this.onTap]);
  final String markerId;
  final latlng.LatLng location;
  final Future Function()? onTap;
}

class MundayGoogleMap extends ConsumerStatefulWidget {
  const MundayGoogleMap({
  ...
  final Iterable<MundayMarker> markers;
  ...
  @override
  ConsumerState<MundayGoogleMap> createState() => _MundayGoogleMapState();
}

class _MundayGoogleMapState extends ConsumerState<MundayGoogleMap> {
  ...
  @override
  void didUpdateWidget(MundayGoogleMap oldWidget) {
