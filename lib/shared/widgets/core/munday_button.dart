...
class MundayButtonOptions {
  const MundayButtonOptions({
    this.textAlign,
    this.textStyle,
    this.elevation,
    this.height,
...
class MundayButton extends ConsumerStatefulWidget {
  const MundayButton({
    super.key,
    required this.text,
  ...
  final MundayButtonOptions options;
  final bool showLoadingIndicator;
  final FocusNode? focusNode;

  @override
  ConsumerState<MundayButton> createState() => _MundayButtonState();
}

class _MundayButtonState extends ConsumerState<MundayButton> {
  bool loading = false;
...
class FFFocusIndicator extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FFFocusIndicator> createState() => _FFFocusIndicatorState();
}

class _FFFocusIndicatorState extends ConsumerState<FFFocusIndicator> {
