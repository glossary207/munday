...
class Mapshow extends ConsumerStatefulWidget {
  const Mapshow({
    super.key,
    this.width,
    this.height,
  ...
  @override
  ConsumerState<Mapshow> createState() => _MapshowState();
}

class _MapshowState extends ConsumerState<Mapshow> {
  ...
  void didUpdateWidget(covariant Mapshow oldWidget) {
    ...
    if (widget.moveMapCondition == true) {
      ...
      // (ถ้าเป็น AppState() ก็เรียก context.appState.MoveMap = false ได้)
    }
  }
