...
class DynamicMap extends ConsumerStatefulWidget {
  const DynamicMap({
    super.key,
    this.width,
    this.height,
  ...
  @override
  ConsumerState<DynamicMap> createState() => _DynamicMapState();
}

class _DynamicMapState extends ConsumerState<DynamicMap> {
