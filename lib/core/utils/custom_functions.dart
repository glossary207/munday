...
List<dynamic>? jsonDataRoomAndStore(
  ...
  return roomdata?.map((room) {
    ...
    storedata?.user?.forEach((dynamic user) {
...
List<dynamic>? dataEvent(
  ...
  print("DEBUG dataEvent: Received ${events.length} events from Supabase");
  ...
  print("DEBUG dataEvent: Returning ${paginatedEvents.length} events to UI");
