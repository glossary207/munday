...
export 'package:munday/core/state/base_model.dart';
export 'dart:math' show min, max;
export 'dart:typed_data' show Uint8List;
export 'dart:convert' show jsonEncode, jsonDecode;
export 'package:intl/intl.dart';
export '/backend/supabase/supabase_shim.dart'
    show SupabaseDocRef, SupabaseFirestore;
...
extension MundayTextEditingControllerExt on TextEditingController? {
...
extension StringDocRef on String {
  SupabaseDocRef get ref => SupabaseFirestore.instance.doc(this);
}
