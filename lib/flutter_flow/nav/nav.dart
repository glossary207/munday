...
GoRouter createRouter(AppStateNotifier appStateNotifier) {
  $lock_orientation_library_opafp4.initializeRoutes(
    ...
    homePageWidgetPath: 'homePage_lock-orientation-library-opafp4',
  );
    ...
    routes: [
      FFRoute(
        ...
        routes: [
          ...
          FFRoute(
            name: InVenuseWidget.routeName,
            path: InVenuseWidget.routePath,
            requireAuth: false,
            builder: (context, params) => InVenuseWidget(
          ...
          FFRoute(
            name: VeerWidget.routeName,
            path: VeerWidget.routePath,
            requireAuth: true,
          ...
          FFRoute(
            ...
            requireAuth: false,
            builder: (context, params) => ShowallphotoWidget(
          ...
          FFRoute(
            ...
            requireAuth: true,
            builder: (context, params) => SharepageWidget(
              idVenues: params.getParam(
                'idVenues',
                ParamType.SupabaseDocRef,
                isList: false,
