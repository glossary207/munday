...
export 'sharepage_model.dart';

class SharepageWidget extends StatefulWidget {
  const SharepageWidget({
    super.key,
    this.idVenues,
    this.distance,
    this.dateclick,
  ...
  static String routeName = 'sharepage';
  static String routePath = 'sharepage';

  @override
  State<SharepageWidget> createState() => _SharepageWidgetState();
}

class _SharepageWidgetState extends State<SharepageWidget>
    with TickerProviderStateMixin {
  late SharepageModel _model;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget.dateclick != null) {
        ...
        FFAppState().dateclick = functions.boxstarttime(getCurrentTimestamp);
        safeSetState(() {});
      }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<VenuesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final sharepageVenuesRecord = snapshot.data!;
                                                                      ...
                                                                      return GestureDetector(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              ReviewWidget(
                                                                            idVenues:
                                                                                sharepageVenuesRecord.reference,
                                                                          ),
                                                                        ),
                                                                      );
                                                                    },
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Text(
                                                                      functions
                                                                          .distanceLocation(
                                                                              sharepageVenuesRecord.position,
                                                                              currentUserLocationValue)
                                                                          .toString()
                                                                          .maybeHandleOverflow(
                                                                            maxChars:
                                                              ...
                                                              if (sharepageVenuesRecord
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      await launchURL(functions.linkLine(sharepageVenuesRecord
                                                                          .linkContact
                                                                          .line)!);
                                                                    },
                                                                    child:
                                  ...
                                  child: TabBarView(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final events = sharepageVenuesRecord
                                                .events
                                                .toList();
                                                              ...
                                                              builder:
                                                                ...
                                                                return GestureDetector(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        PosterPresentWidget(
                                                                      detail: containerEventsRecord
                                                                          .detail,
                                                                      poster: containerEventsRecord
                                                                          .poster,
                                                                    ),
                                                                  ),
                                                                );
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  functions.dateEventday(containerEventsRecord.date).toString(),
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  valueOrDefault<String>(
                                                                                    functions.dateMonthTH(containerEventsRecord.date),
                                                                                    'ไม่ระบุ',
                                                                                  ),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        font: GoogleFonts.openSans(
                                      ...
                                      Padding(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final pro = sharepageVenuesRecord
                                                .promotion
                                                .toList();
