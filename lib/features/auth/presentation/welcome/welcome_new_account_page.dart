...
class WelcomeNewAccountPage extends ConsumerStatefulWidget {
  const WelcomeNewAccountPage({super.key});

  static String routeName = 'WelcomeNewAccount';
  static String routePath = 'welcome-new-account';

  @override
  ConsumerState<WelcomeNewAccountPage> createState() =>
      _WelcomeNewAccountPageState();
}

class _WelcomeNewAccountPageState extends ConsumerState<WelcomeNewAccountPage> {
  ...
  void initState() {
    super.initState();
    _igController.text = context.appState.profileInstagramHandle;
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (_) {
                          context.appState.update(() {
                            context.appState.profileInstagramHandle =
