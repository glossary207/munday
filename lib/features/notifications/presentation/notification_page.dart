...
const _mockNewsItems = <_MockNews>[
  ...
  _MockNews(
    ...
    detail:
        'Buy one get one free on all signature cocktails this weekend only.',
    date: 'Tomorrow',
    isFree: false,
    emoji: '🍹',
    category: 'PROMO',
  ...
  _MockNews(
    ...
    detail:
        'Join us for the biggest opening of the year. Live DJ sets all night.',
    date: '25 May',
    isFree: true,
    emoji: '🥂',
    category: 'EVENT',
  ...
  _MockNews(
    ...
    detail:
        'Local bands competing for the Khao San trophy. Free standing area.',
    date: '27 May',
    isFree: true,
    emoji: '🎸',
    category: 'MUSIC',
...
class _NotificationPageState extends ConsumerState<NotificationPage> {
  ...
  Widget _buildMockActivityCard(_MockNotif item) {
    return Material(
      color: item.isUnread ? const Color(0xFF0D0D0D) : Colors.transparent,
      child: InkWell(
        onTap: () {},
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      item.isUnread ? '${item.time} · ใหม่' : item.time,
                      style: GoogleFonts.openSans(
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        return _buildNotifRow(
          ...
          iconColor: _kBlue,
          time: null,
          onTap: () => context.pushNamed(MainChatPage.routeName),
        );
      },
    );
  }
  ...
  Widget _buildMockTicketCard(int index, _MockTicket ticket) {
    ...
    return Column(
      ...
      children: [
        Material(
          color: ticket.isUnread ? const Color(0xFF0D0D0D) : Colors.transparent,
          child: InkWell(
            onTap: () {},
            splashColor: Colors.white.withValues(alpha: 0.03),
            child: Padding(
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () => setState(() => _dismissedMockTickets.add(index)),
                  child: Container(
                    height: 34,
                    decoration: BoxDecoration(
                      color: const Color(0xFF3A3A3A),
