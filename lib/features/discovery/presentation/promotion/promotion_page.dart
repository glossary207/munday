...
class PromotionPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PromotionPage> createState() => _PromotionWidgetState();
}

class _PromotionWidgetState extends ConsumerState<PromotionPage>
  ...
  void initState() {
    super.initState();
    _model = PromotionModel()..internalInit(context);
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                                                ...
                                                builder: (context) => Builder(
                                                  builder: (context) {
                                                    ...
                                                    return Column(
                                                      mainAxisSize:
                                                          MainAxisSize.max,
                                                      children: List.generate(datapromotion.length, (
                                                        datapromotionIndex,
                                                      ) {
                                                        final datapromotionItem =
                                                            datapromotion[datapromotionIndex];
                                                        return Padding(
                                                          padding:
                                                              EdgeInsetsDirectional.fromSTEB(
                                                                10.0,
                            ...
                            if (_model.mapon! &&
                                (context.appState.VenuseSelection?.id != null &&
                                    context.appState.VenuseSelection?.id != ''))
                              Align(
                                alignment: AlignmentDirectional(-1.0, 1.0),
                                child: Container(
                                  height: 220.0,
                                  ...
                                  child: Padding(
                                    ...
                                    child:
                                        ChangeNotifierProvider.value(
                                          value: _model.rowpromotionModel2
                                              .setOnUpdate(
                                                onUpdate: () =>
                                                    safeSetState(() {}),
                                                updateOnChange: true,
                                          ...
                                          animationsMap['rowpromotionOnPageLoadAnimation']!,
                                        ),
                                  ),
                                ),
                              ),
