...
class _BookingWidgetState extends State<BookingWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().SeatSelect = [];
      FFAppState().Totlepricebooking = 0;
      safeSetState(() {});
    });
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                // context.pushNamed(Booking2cWidget.routeName);
                              },
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'zl6cyp0w' /* Select Table */,
                                ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  functions.month(FFAppState().dateclick),
                                  'ไม่ระบุ',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child: custom_widgets.Calendarslide(
                              ...
                              dateclickwidget: FFAppState().dateclick,
                          ...
                          if (true)
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      PayreservenormdayWidget.routeName);
                                },
                                child: Container(
                                  width: MediaQuery.sizeOf(context).width * 0.7,
                                  height: 50.0,
