...
class TicketPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TicketPage> createState() => _TicketWidgetState();
}

class _TicketWidgetState extends ConsumerState<TicketPage>
  ...
  void initState() {
    super.initState();
    _model = TicketModel()..internalInit(context);
