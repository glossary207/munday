...
class _PhotoshowGalleryViewerState extends ConsumerState<_PhotoshowGalleryViewer> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundOpacity =
        (1.0 - (_verticalDragOffset / 260.0)).clamp(0.0, 1.0).toDouble();
